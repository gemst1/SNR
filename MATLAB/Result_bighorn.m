...
img_noisy = double(importdata('./bighorn/noisy.mat')).*255;
img_domain = double(importdata('./bighorn/dynamicmask.mat')).*255;
img_jitter = double(importdata('./bighorn/jitter.mat')).*255;
img_BM3D = double(importdata('./bighorn/BM3D.mat')).*255;
img_unet = double(importdata('./bighorn/unet.mat')).*255;

mask_red = [788 708 199 199];
mask_green = [178 1148 599 599];
...
if image_save == 1
print(f1,'-depsc2','-painters','bighorn_dynami_mask.eps')
print(f2,'-depsc2','-painters','bighorn_spatial_jitter.eps')
print(f3,'-depsc2','-painters','bighorn_BM3D.eps')
print(f4,'-depsc2','-painters','bighorn_Unet.eps')
print(f5,'-depsc2','-painters','bighorn_noisy.eps')
end